...
@Component
class NaverPlaceRelay : Relayable {
    companion object {
        private const val SLUG = "naver-place-dev"
        private val yearList = listOf(2019, 2020, 2021, 2022, 2023, 2024)
    }
    ...
    override fun isSupportType(blogType: BlogType): Boolean {
        return blogType == BlogType.NAVER_PLACE
    }
}
