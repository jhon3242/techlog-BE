...
@Component
class WantedRelay : Relayable {
    companion object {
        private const val SLUG = "wantedjobs"
        private val yearList = listOf(2018, 2019, 2020, 2021, 2022, 2023, 2024)
    }
    ...
    override fun isSupportType(blogType: BlogType): Boolean {
        return blogType == BlogType.WANTED
    }
}
