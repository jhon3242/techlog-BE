...
@Component
class MegazoneCloudRelay : Relayable {
    companion object {
        private const val SLUG = "cloudvillains"
        private val yearList = listOf(2021, 2022, 2023, 2024)
    }
    ...
    override fun isSupportType(blogType: BlogType): Boolean {
        return blogType == BlogType.MEGAZONE_CLOUD
    }
}
